...
export function RelatorioAct({navigation}: NavigationProp){
    ...
    const [notas,setNotas] = useState([
        {id: '1', aluno: 'Leidia T.R', top: 'Interface', desc: 'Atv. Revisão'},
        {id: '2', aluno: 'Janina B. A', top: 'Flat List', desc: 'Atv. Avaliativa'},
        {id: '3', aluno: 'Geovana R. T', top: 'React', desc: 'Atv. Avaliativa'},
        ...
        <View>
            ...
            <View style={styles.container}>
                <Picker
                    ...
                    style={styles.caixa}
                    onValueChange={()=>navigation.navigate('RelatorioActSub')}
                >
                    <Picker.Item label="Atividades com atraso" value="atvAtraso" />
                    <Picker.Item label="Atividades não entregues" value="atvNentreg" />
                    <Picker.Item label="Alteração da submissão" value="altsubmit"/>
                </Picker>
            </View>
            ...
            <TouchableOpacity style={styles.gerarButton}  onPress={() => {}}> 
                <Text style={styles.gerarText}>Gerar Relatório </Text>
            </TouchableOpacity>

            <Text style= {styles.titleCard}>Relatório - Atividades em atraso </Text>
            <DataTable>
